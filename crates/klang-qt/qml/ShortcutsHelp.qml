...
Item {
    ...
    readonly property var rows: [
        ...
        { key: "Ctrl+Shift+→", label: Tr.t("Forward 10 seconds") },
        { key: "Ctrl+Shift+←", label: Tr.t("Back 10 seconds") },
        { key: "M", label: Tr.t("Mute / Unmute") },
        { key: "L", label: Tr.t("Like / Unlike current track") },
        { key: "Ctrl+S / Alt+S", label: Tr.t("Shuffle on / off") },
        { key: "Alt+R", label: Tr.t("Repeat off / all / one") },
        { key: "Ctrl+F / Ctrl+K", label: Tr.t("Focus search bar") },
        { key: "Ctrl+,", label: Tr.t("Settings") },
        { key: "Ctrl+[", label: Tr.t("Back") },
        { key: "Ctrl+]", label: Tr.t("Forward") },
